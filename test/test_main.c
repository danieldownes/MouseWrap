...
extern void test_near_edge_vertical_span_is_half_open(void);
...
extern void test_near_edge_screen_sides_are_symmetric(void);
extern void test_near_edge_corner_pixels(void);
...
extern void test_resolve_dragging_overrides_delayed_edges(void);
extern void test_resolve_dragging_never_enables_nowrap_edges(void);
...
int main(void) {
    ...
    RUN_TEST(test_near_edge_vertical_span_is_half_open);
    ...
    RUN_TEST(test_near_edge_screen_sides_are_symmetric);
    RUN_TEST(test_near_edge_corner_pixels);
    ...
    RUN_TEST(test_resolve_dragging_overrides_delayed_edges);
    RUN_TEST(test_resolve_dragging_never_enables_nowrap_edges);
